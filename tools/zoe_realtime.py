...
PERSONA = (
    ...
    "work on his Roblox game or Zenthra, use roblox to open Studio, then see_screen to understand it "
    "and screen_task to build in it, and run the roblox skill (use_skill roblox) for the workflow; "
    "for serious Luau coding, offer to set up Rojo so you can write scripts as files. "
